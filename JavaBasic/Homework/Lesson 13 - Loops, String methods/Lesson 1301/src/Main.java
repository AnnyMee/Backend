/*
Реализовать метод, который в качестве параметров принимает строку и символ. Метод должен вернуть,
сколько раз заданный символ встречается в заданной строке. Например:

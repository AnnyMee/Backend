...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("or insert any other number to switch off: ");

            chosenCoffee = scanner.nextInt();
            processMakingCoffee(chosenCoffee);
        }while (chosenCoffee>=1 && chosenCoffee<=4);
    ...
    public static void processMakingCoffee(int chosenCoffee) {
        ...
        switch (chosenCoffee) {
            ...
            default: System.out.println("Switching off");
        }

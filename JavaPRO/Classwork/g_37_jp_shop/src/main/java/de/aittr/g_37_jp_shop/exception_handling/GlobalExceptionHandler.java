...
// ПЛЮС - мы создаём глобальный обработчик исключений, который может ловить исключения, относящиеся ко всем контроллерам сразу.
// Мы отделяем логику обработки исключений от основной логики нашего приложения,
// тем самым мы облегчаем процесс поддержки и доработки проложения.
// МИНУС - это способ нам не подходит в случае когда нам требуется разная логика обработки одного и того же исключения в разных контроллерах.

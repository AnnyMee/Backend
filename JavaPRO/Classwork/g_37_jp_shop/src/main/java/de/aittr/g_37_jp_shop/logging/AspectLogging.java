...
public class AspectLogging {
    ...
    public void beforeSavingProduct(JoinPoint joinPoint) {
        // Advice - тот код, который и будет внедряться в основной код, используя правило, описанное в @Pointcut
    ...
    public void afterThrowingAnExceptionWhileGettingProductById(Exception e) {
        logger.warn("Method getById of the class ProductServiceImpl threw an exception while getting product: " + "message - {}", e.getMessage());
    }
